...
class LifeCycleDemoView extends StatefulWidget {
  const LifeCycleDemoView({Key? key}) : super(key: key);

  @override
  State<LifeCycleDemoView> createState() => _LifeCycleDemoViewState();
}

class _LifeCycleDemoViewState extends State<LifeCycleDemoView> {
  @override
  void initState() {
    super.initState();
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (search.isNotEmpty) {
                    var str = search.toString().toLowerCase();
                    var productName =
