...
//Buatlah sebuah List<Map> berisi data category produk pada Furniture. Isi dengan 10 contoh data
...
//Buatlah sebuah List<Map> products, berisi 10  product furniture dengan data id, product_name, photo, dan price
  List<Map> products = [
    {
      'id': 1,
      'product_name': 'Sofa',
