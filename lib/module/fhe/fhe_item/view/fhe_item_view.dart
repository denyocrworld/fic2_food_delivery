...
class FheItemView extends StatefulWidget {
  const FheItemView({Key? key}) : super(key: key);

  Widget build(context, FheItemController controller) {
    controller.view = this;

    return Scaffold(
      appBar: AppBar(
        title: const Text("FheItem"),
        actions: const [],
      ),
  ...
  @override
  State<FheItemView> createState() => FheItemController();
}
