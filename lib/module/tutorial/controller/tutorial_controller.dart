...
class TutorialController extends State<TutorialView> implements MvcController {
  ...
  List messages = [
    ...
    },
    {
      ...
      'is_me': true,
      'message': 'Have you heard about Dart and Flutter?'
    },
    {
      'id': 8,
      'created_at': '2020-08-08',
      'is_me': false,
      'message': 'Yes, I have heard about them. What about them?'
    },
    {
      'id': 9,
      ...
      'is_me': true,
      'message':
          'They are programming languages used to develop mobile applications.'
    },
    {
      'id': 10,
      'created_at': '2020-08-10',
      'is_me': false,
      'message': 'That is really interesting!'
    }
  ];
