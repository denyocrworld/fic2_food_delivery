import 'package:example/shared/theme/grab_inspired_theme.dart';
import 'package:flutter/material.dart';
import 'package:example/core.dart';

class MaLoginView extends StatefulWidget {
  const MaLoginView({Key? key}) : super(key: key);

  Widget build(context, MaLoginController controller) {
  ...
  @override
  State<MaLoginView> createState() => MaLoginController();
}
