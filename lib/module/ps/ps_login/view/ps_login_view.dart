...
import '../controller/ps_login_controller.dart';

class PsLoginView extends StatefulWidget {
  const PsLoginView({Key? key}) : super(key: key);

  Widget build(context, PsLoginController controller) {
  ...
  @override
  State<PsLoginView> createState() => PsLoginController();
}
