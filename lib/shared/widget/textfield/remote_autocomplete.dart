...
class AutoCompleteWithRemoteDataSource extends StatefulWidget {
  final String value;
  ...
  const AutoCompleteWithRemoteDataSource({
    Key? key,
    required this.value,
  ...
  @override
  State<AutoCompleteWithRemoteDataSource> createState() =>
      AutoCompleteWithRemoteDataSourceState();
}

class AutoCompleteWithRemoteDataSourceState
    extends State<AutoCompleteWithRemoteDataSource> {
  List<Map> items = <Map>[];
  bool loading = false;
