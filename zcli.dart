...
""");
    ...
    var docsTsFile = File(
        r"C:\Users\denyo\Documents\FLUTTER_PROJECT\flutter-hyper-extension-vscode\src\docs\docs.ts");
...
getDocsByGroup(List docCodes, String groupName) {
...
Be careful, you should press this button when your project is still empty to avoid unwanted things. Because this command will generate main.dart, setup.dart, riverpod_util.dart and also update your pubspec.yaml
      ...
      <vscode-button class="title" style="background-color: #2B3E51 !important;color: #FFF !important">Bloc</vscode-button>
      <vscode-button class="item create-project" id="bloc">Blank</vscode-button>
...
generateDocumentation(List docCodes) {
  List groupList = [];
  List docList = [];
...
""");
  ...
  var testMode = true;
  var file = File(
      r"C:\Users\denyo\Documents\FLUTTER_PROJECT\flutter-hyper-extension-vscode\src\provider\html.ts");
